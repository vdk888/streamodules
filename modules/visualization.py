...
def create_portfolio_performance_chart(portfolio_df: pd.DataFrame) -> go.Figure:
    ...
    # Copy y-axis settings
    fig.update_yaxes(title=fig1.layout.yaxis.title, row=1, col=1)
    fig.update_yaxes(title=fig1.layout.yaxis2.title, secondary_y=True, row=1, col=1)
    fig.update_yaxes(title=fig2.layout.yaxis.title, row=2, col=1)
    fig.update_yaxes(title=fig2.layout.yaxis2.title, secondary_y=True, row=2, col=1)
